...
$applicationCode = "FNWqwwgGrrtR5Bg5l6dcnEigVb3yenTC";
 $key = "XhtNbbDYOOQo5TG5I621KWFDs03dBKqU";
  $data['applicationCode'] = $applicationCode;
   $data['referenceId'] = guid();
     $data['version'] = "v1";
// $data['virtualCurrencyName'] = "testing";
   // $data['virtualCurrencyAmount'] = "10";
  $data['returnUrl'] = "http://107.150.101.9:5100/iosMolBilling.aspx";
  $data['amount'] = "100";
  //$data['channelId'] = "";
  ...
  $data['customerId'] = "customer01";
    ...
    $data['Serial'] = "7516010618";
  $data['Pin'] = "99997516010618";
  $data['Denomination'] = "MYR 10";
