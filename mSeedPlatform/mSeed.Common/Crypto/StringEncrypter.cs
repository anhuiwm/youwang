 ...
 * Since	2007.10.09
 * Version	$Id: StringEncrypter.cs 277 2013-06-04 15:24:08Z Hyeong-Ryeol $
 * 
...
namespace Ryeol.Security.Cryptography
{
    ...
    public class StringEncrypter
    {
        ...
        public string Encrypt(byte[] value)
        {
            ...
            // Encrypts the UTF-8 byte array.
            byte[] encryptedValue = transform.TransformFinalBlock(value, 0, value.Length);
