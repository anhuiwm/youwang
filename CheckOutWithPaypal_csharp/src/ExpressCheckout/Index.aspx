<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Index.aspx.cs" Inherits="ExpressCheckout.Index" %>
        ...
        <div class="container-fluid">
            <div class="well">
                <h2 class="text-center">
                    <img src="img/logo.jpg"/>Checkout with PayPal Demo
                </h2>
            </div>
            <div class="row-fluid">
                <div class="span6">
                    ...
                    <form class="form" runat="server" id="ExpressCheckoutForm" action="SetExpressCheckout.aspx?ExpressCheckoutMethod=ShorcutExpressCheckout">
                        <div class="row-fluid show-grid">
                            <div class="span6 inner-span">
                                ...
                                <table>
                                    <tr><td><h3>Starbucks Caffe Verona Coffee</h3></tr>
                                    <tr><td><img src="img/starbucks_caffe_verona_coffee.png" width="300" height="250"/></td></tr>
...
<pre>
<code>
&lt;form id="myContainer" action="SetExpressCheckout.aspx" method="POST"&gt;
    ...
    <i>&lt;!-- Pass additional input parameters based on your shopping cart. 
         For complete list of all the parameters <a href="https://developer.paypal.com/webapps/developer/docs/classic/api/merchant/SetExpressCheckout_API_Operation_NVP/" target=_blank>click here</a></i> --&gt;
&lt;/form&gt;
</code>
</pre>
                            <br>
...
window.paypalCheckoutReady = function () {
    paypal.checkout.setup('Your merchant email id', {
        container: 'myContainer', // {String|HTMLElement|Array}  
                                  // Indicates where the PayPal button will reside.
...
&lt;script src="//www.paypalobjects.com/api/checkout.js" async&gt;&lt;/script&gt;
                            ...
                            <br><br>
<pre>
<code>&lt;form action="SetExpressCheckout.aspx" method="POST"&gt;
    &lt;input type="hidden" name="PAYMENTREQUEST_0_AMT" value="10.00"&gt;&lt;/input&gt;
    &lt;input type="hidden" name="currencyCodeType" value="USD"&gt;&lt;/input&gt;
    &lt;input type="hidden" name="paymentType" value="Sale"&gt;&lt;/input&gt;
    <i>&lt;!--Pass additional input parameters based on your shopping cart. 
            ...
            $(document).ready(function () {
                $("#mark_ec").click(function (event) {
                    ...
                    window.location.replace(
                        "MarkExpressCheckout.aspx?item_name=" + item_name
                        + "&item_id=" + item_id
                        + "&item_desc=" + item_desc
