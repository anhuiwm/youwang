<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="MarkExpressCheckout.aspx.cs" Inherits="ExpressCheckout.MarkExpressCheckout" %>
<!DOCTYPE html>
<html>
	  <head>
		  <meta charset="utf-8" />
            ...
            <asp:HiddenField id="PAYMENT_TYPE" runat="server" />
               ...
               <div class="row-fluid">
                  <div class="span6 inner-span">
                        ...
                        <table>
                        <tr><td>First Name:</td><td><asp:TextBox runat="server" id="FIRST_NAME"  Text="Michael"/></td>
                            <td>
					...
					<tr><td colspan="2"><input id="payment_method_creditcard" value="paypal_express" type="radio" name="payment[method]" title="PayPal Express Checkout" class="radio" disabled>&nbsp;Credit Card</td></tr>
					<tr><td>&nbsp;</td></tr>
						<tr><td colspan="2">
