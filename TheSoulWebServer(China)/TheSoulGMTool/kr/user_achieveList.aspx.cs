...
{
    public partial class user_achieveList : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            int achieve = queryFetcher.QueryParam_FetchInt("achieveType", 2);
        ...
        protected void GetDataList(int pageIndex)
        {
            ...
            TxnBlock tb = new TxnBlock();
            {
                try
                {
                    ...
                    int achieve = queryFetcher.QueryParam_FetchInt(achieveType.UniqueID, 2);
                    ...
                    if (!Page.IsPostBack)
                    {
                        ...
                        achieve = achieve < 2 ? queryFetcher.QueryParam_FetchInt("achieveType", 2) : achieve;
                    }
                    username.Text = Username;
                    uid.Text = Uid;
                    achieveType.SelectedValue = achieve.ToString();
                    ...
                    if (!string.IsNullOrEmpty(Username) || !string.IsNullOrEmpty(Uid))
                    {
                        ...
                        long totalCount = GMDataManager.GetUserAchieveCount(ref tb, AID, achieve);

                        List<GM_User_Event> logList = GMDataManager.GetUserAchieveList(ref tb, AID, pageIndex, achieve);
                        ...
                        GMDataManager.PopulatePager(ref dlPager, totalCount, pageIndex, 20);
