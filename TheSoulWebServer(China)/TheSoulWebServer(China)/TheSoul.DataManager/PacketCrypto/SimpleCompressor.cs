...
namespace NAMU
{
    ...
    public static class SimpleCompressor
    {
        ...
        public static class Unchecked
        {
            ...
            /// </summary>
            /// <exception cref="Ionic.Zlib.ZlibException"></exception>
            public static byte[] CompressStringToByte(string s, Encoding encoding)
            {
        ...
        /// <summary>
        /// Call Unchecked.CompressString(), returns null instead if exception are thrown.
        /// </summary>
        public static string CompressString(string s, Encoding encoding)
        {
            string result;
        ...
        /// <summary>
        /// Call Unchecked.DecompressString(), returns null instead if exception are thrown.
        /// </summary>
        public static string DecompressString(string base64string, Encoding encoding)
        {
            string result;
