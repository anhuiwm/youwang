<%@ Page Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true" CodeBehind="rankingList.aspx.cs" Inherits="TheSoulGMTool.User.rankingList" %>
    ...
    <div class="span9">
        <table class="table table-bordered" style="width: 70%;">
            <tr>
                ...
                <th <%if(pvptype.Value == "2"){ %>style="background-color:#EAEAEA;"<%} %>>
        ...
        <asp:GridView ID="dataList" CssClass="table table-bordered" runat="server" AutoGenerateColumns="false">
            <Columns>
                ...
                <asp:TemplateField HeaderText="<%$ Resources:languageResource ,lang_btn_delete %>">
                    <ItemTemplate>  
                        <button type="button" class="btn" onclick="rankingDelete(<%#Eval("aid")%>);"><asp:Label ID="Label9" Text="<%$ Resources:languageResource ,lang_btn_delete %>" runat="server" ></asp:Label></button>
                    </ItemTemplate>
                </asp:TemplateField>
            </Columns>
        </asp:GridView>
