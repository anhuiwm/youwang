<%@ Page Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true" CodeBehind="user_achieve.aspx.cs" Inherits="TheSoulGMTool.kr.user_achieve" %>
    ...
    <div class="span9">
        ...
        <table class="table table-bordered">
            <tbody>
                ...
                <tr>
                    <th></th>
                    <th><%$ Resources:languageResource ,lang_clearCondition %></th>
                    <th><%$ Resources:languageResource ,lang_progression %></th>
                    <th><%$ Resources:languageResource ,lang_change %></th>
                </tr>
                <tr>
