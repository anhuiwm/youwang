...
namespace mSeed.RedisManager
{
    public partial class mJsonSerializer
    {
        ...
        public static JsonObject RemoveJsonObject(JsonObject json, string key)
        {
            if (json == null)
                json = new JsonObject();
        ...
        public static JsonArrayObjects AddJsonArray(JsonArrayObjects baseArray, JsonObject json)
        {
            if (baseArray == null)
                baseArray = new JsonArrayObjects();
        ...
        public static JsonArrayObjects AddJsonArray(JsonArrayObjects baseArray, string json)
        {
            if (baseArray == null)
                baseArray = new JsonArrayObjects();
