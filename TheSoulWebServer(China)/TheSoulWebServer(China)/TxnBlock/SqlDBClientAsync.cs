...
{
    public partial class SqlDBClientAsync
    {
        ...
        public SqlDBClientAsync()
        {
            reset_internal();
        }

        public SqlDBClientAsync(DBEndpoint conn, string TxnKey, bool debugFlag = true)
        {
            reset_internal();
        ...
        public SqlDBClientAsync(string conn, string TxnKey, bool debugFlag = true)
        {
            reset_internal();
            debug = debugFlag;
        ...
        public async Task<SqlDataReader> AsyncExcuteQuery(SqlConnection conn, SqlCommand cmd)
        {
            await conn.OpenAsync();            
            if (conn != null)
        ...
        SqlDataReader GetAsync(SqlConnection conn, SqlCommand cmd)
        {
            sqlDR = AsyncExcuteQuery(conn, cmd).Result;
            return sqlDR;
        }


        //public async Task<SqlDataReader> AsyncExcuteQuery(SqlCommand cmd)
        //{
        //    await conn.OpenAsync();
        //    return await cmd.ExecuteReaderAsync();
        //}
        ...
        //public Task<SqlDataReader> ExcuteSqlCommandAsync(ref SqlCommand command, ref SqlDataReader reader, bool txnFlag = true)
        //{
